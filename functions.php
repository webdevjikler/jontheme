<?php
/**
 * jontheme functions and definitions
 *
...
if ( ! function_exists( 'jontheme_setup' ) ) :
	/**
	 ...
	 */
	function jontheme_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on jontheme, use a find and replace
		 * to change 'jontheme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'jontheme', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'jontheme' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'jontheme_custom_background_args', array(
...
add_action( 'after_setup_theme', 'jontheme_setup' );
 ...
 */
function jontheme_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'jontheme_content_width', 640 );
}
add_action( 'after_setup_theme', 'jontheme_content_width', 0 );
 ...
 */
function jontheme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'jontheme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'jontheme' ),
...
add_action( 'widgets_init', 'jontheme_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function jontheme_scripts() {
	wp_enqueue_style( 'jontheme-style', get_stylesheet_uri() );

	wp_enqueue_script( 'jontheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
...
add_action( 'wp_enqueue_scripts', 'jontheme_scripts' );
